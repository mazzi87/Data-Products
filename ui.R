...
shinyUI(navbarPage("Let me find the best car for you",
                   tabPanel("Table",
                            ...
                            sidebarLayout(
                                    sidebarPanel(
                                            ...
                                            numericInput('dis', 'Distance (in miles):', 50, min = 1, max = 1000, step = 10),
                                            numericInput('cost', 'Gasoline Price (per gallon):', 2.00, min = 1.5, max = 4, step=0.01),
